...
public class my_post extends AppCompatActivity {
    ...
    Runnable r1 = new Runnable() {
        @Override
        public void run() {
            forum_cardview = webservice.user_post_cardview(gmail);
            Log.v("test123456","Fo:::::"+forum_cardview+gmail+"WHY");
            all_like_post=webservice.Select_like_myself_post(gmail);
            Log.v("test123456","CA:::::"+all_like_post);
            mUI_Handler.post(r2);
        }
    };
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable(){
                ...
                public void run() {
                    ...
                    for(int i = 0 ; i < split_cardview.length ; i++) {
                        ...
                        Log.v("test123456","all:::::"+split_cardview_info[1]+k+all_like_post);
