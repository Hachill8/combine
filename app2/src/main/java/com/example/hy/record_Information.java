...
public class record_Information extends AppCompatActivity {
    int index = 0, ly=330,num=0,cy=810;
    boolean fg = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardviewList.add(new record_Cardview("幼苗期", "19/04/27~19/04/28", "澆水25次", "施肥1次", "間拔5次", R.drawable.imv03));

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        recyclerView.setAdapter(new CardAdapter(this, cardviewList));
        // 取得 RelayiveLayout 物件
        RelativeLayout RL = (RelativeLayout) findViewById(R.id.record_information_RL);
    ...
    private class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
        ...
        public CardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.record_cardview, parent, false);
